...
fig, ax = plt.subplots(2,1,figsize=(16,16), gridspec_kw={'height_ratios': [5, 1]})
ax[0].set_title("Disk usage", family='Arial', fontsize=50, fontweight='bold')
ax[0].pie(sizes, explode=explode, labels=labels, autopct='%1.1f%%', shadow=False, startangle=90, colors= colors, labeldistance=0.1, textprops={'fontsize': 40} ) 
ax[0].axis('equal')  # Equal aspect ratio ensures that pie is drawn as a circle.


ax[1].set_title("/boot usage", family='Arial', fontsize=50, fontweight='bold')
